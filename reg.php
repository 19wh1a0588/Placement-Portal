...
<div class="w3-container w3-main" style="margin-left:250px;">
  <div class="w3-container w3-center w3-green"> <h4>Registration Details</h4></div>


<form class="w3-container" action="add_reg.php">
  <div class="w3-section">
      
      <label><b>Roll Number</b></label>
    <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="" maxlength="50" name="Rollno" required>
    <label><b>Email</b></label>
    <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="" maxlength="50" name="email" required>
    ...
    <label><b>Participation in Events</b></label>
    <br><br>
    <table>
        <tr>
            <td colspan="20">
        ...
        <tr>
            ...
            <td><b>Event</b></td>
            <td><b>Count</b></td>
            <td><b>List of Events</b></td>
        </tr>
        <tr>
            <td><b>1</b></td>
            <td><b>Hackathons</b></td>
            <td><input type="number"  name="Hackathon" value="value1"></td>
            <td><input type='text' placeholder='' maxlength='10' name='value1'required></td>
        </tr>
        <tr>
            <td><b>2</b></td>
            <td><b>Ideathons</b></td>
            <td><input type="number"  name="Ideathon" value="value2"></td>
            <td><input type='text' placeholder='' maxlength='10' name='value1'required></td>
        </tr>
        <tr>
            <td><b>3</b></td>
