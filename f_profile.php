...
<nav class="w3-sidebar w3-fixed  w3-bar-block w3-collapse  w3-card w3-light-grey" style="z-index:13;width:250px;" id="mySidebar">
  ...
  <div>
      <a class="w3-bar-item w3-button" href="f_profile.php">Profile updation</a>
...
<form class="w3-container" action="addp_profile.php">
  <div class="w3-section">
    ...
    <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="" maxlength="9" name="C_Address" required>
    <label><b>Permanent Address</b></label>
    <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="" maxlength="9" name="P_Address" required>
    ...
    <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="" maxlength="9" name="bloodgroup" required>
